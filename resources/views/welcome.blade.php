            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <img src="{{ asset('images/school_logo.png') }}" alt="School Logo"
                        class="h-8 w-auto sm:h-10 animate-pulse">
                    <div class="ml-2 sm:ml-3">
                        <h1 class="text-sm sm:text-lg font-semibold text-white">Sitero Francisco Memorial NHS</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
                ...
                <div class="flex flex-col sm:flex-row items-center text-center sm:text-left">
                    <img src="{{ asset('images/school_logo.png') }}" alt="School Logo"
                        class="h-10 w-auto animate-pulse mb-3 sm:mb-0">
                    <div class="sm:ml-3">
                        <p class="font-medium text-sm sm:text-base">Sitero Francisco Memorial NHS</p>
