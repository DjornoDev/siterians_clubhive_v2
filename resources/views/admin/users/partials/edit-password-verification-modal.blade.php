...
<div id="editPasswordVerificationModal"
    ...
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md transform transition-all duration-300 scale-100">
        ...
        <p class="text-gray-700 mb-4">For security reasons, please enter your password to confirm this change.</p>

        <form id="editVerifyPasswordForm">
            <input type="hidden" id="editVerifiedUserId" name="userId">
            <input type="hidden" id="editOriginalFormData" name="formData">

            <div class="mb-4">
                <label for="editPasswordVerificationInput"
                    class="block text-sm font-medium text-gray-700 mb-1">Password</label>
                <div class="relative">
                    <input type="password" id="editPasswordVerificationInput" name="password" required
                ...
                <div id="editPasswordVerificationError" class="mt-2 text-sm text-red-600 hidden"></div>
            </div>

            <div class="flex justify-end gap-3 mt-6">
                <button type="button" onclick="closeEditPasswordVerificationModal()"
...
<div id="updateSuccessModal"
    ...
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md transform transition-all duration-300 scale-100">
        <div class="flex flex-col items-center text-center">
            ...
            <p class="text-gray-600 mb-6">User information has been updated successfully.</p>
            <button onclick="closeUpdateSuccessModal()"
                class="w-full px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors duration-200 font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
                OK
            </button>
        </div>
    </div>
