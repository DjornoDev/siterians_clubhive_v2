...
<div id="viewPasswordVerificationModal"
    ...
    <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md transform transition-all duration-300 scale-100">
        ...
        <p class="text-gray-700 mb-4">Please enter your password to view user details.</p>

        <form id="viewVerifyPasswordForm">
            <input type="hidden" id="viewUserId" name="userId">
            <div class="mb-4">
                <label for="viewPasswordInput" class="block text-sm font-medium text-gray-700 mb-1">Password</label>
                <div class="relative">
                    <input type="password" id="viewPasswordInput" name="password" required
                ...
                <div id="viewPasswordError" class="mt-2 text-sm text-red-600 hidden"></div>
            </div>
