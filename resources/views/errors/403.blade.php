...
<head>
    ...
    <title>{{ config('app.name', 'ClubHive') }} - Access Denied</title>
        ...
        <div class="w-full max-w-lg bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 p-6">
                <div class="flex items-center justify-between">
                    <h1 class="text-3xl font-bold text-white">Error 403</h1>
                ...
                <p class="text-blue-100 mt-1">Access Forbidden</p>
            </div>
            ...
            <div class="p-6">
                <div class="border-l-4 border-yellow-500 bg-yellow-50 p-4 mb-6">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <svg class="h-5 w-5 text-yellow-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor">
                ...
                <div class="text-gray-700 text-base mb-6">
                    ...
                    <p class="mb-4">This error occurs when you attempt to access a resource that requires specific
                        permissions or roles that your account does not have.</p>

                    <div class="space-y-2">
                        <p class="flex items-start">
                            <svg class="h-5 w-5 text-blue-600 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                    clip-rule="evenodd" />
                            </svg>
                            The page may be restricted to users with specific roles (Admin, Teacher, or Student).
                        </p>
                        <p class="flex items-start">
                            <svg class="h-5 w-5 text-blue-600 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20" fill="currentColor">
                            ...
                            You may need to be a member of a specific club to access this content.
                        </p>
                        <p class="flex items-start">
                            <svg class="h-5 w-5 text-blue-600 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20" fill="currentColor">
                            ...
                            Your account may not have the proper permissions to perform this action.
                        </p>
                    </div>
                </div>
